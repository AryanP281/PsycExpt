    ...
    return(<div className="background" id="home">
        <Paper elevation={3} style={{width: "90%", height: "100%", padding: "10px", overflow: "auto"}}>
            ...
            <div className="questionnaire">
                ...
                <Typography variant="body2" style={{marginTop: "10px"}}>What are some of the major themes stated in the narrative? </Typography>
                <TextField variant="outlined" required id="nq1" multiline
                className="form-textfield"
                onChange={(e) => dispatch(setQ1(e.target.value))}
                />
                
                <Typography variant="body2" style={{marginTop: "10px"}}>What person is the narrative in? (first person, second person or third person)</Typography>
                <TextField variant="outlined" required id="nq2" multiline
                className="form-textfield" 
                onChange={(e) => dispatch(setQ2(e.target.value))}
                />

                <Typography variant="body2" style={{marginTop: "10px"}}>Does this narrative seem familiar to you?</Typography>
                <TextField variant="outlined" required id="nq2" multiline
                className="form-textfield" 
