...
function Start()
{
    ...
    return (<div style={{padding: "10%"}}>
            <Typography variant="body1"> Welcome! I am interested in understanding how you respond to stimuli. Before beginning the experiment ensure that you are seated in a room with minimal distractions. Please use your laptop or PC for this experiment, since certain aspects would be better depicted on these devices. Please do not answer calls or perform any other tasks during the experiment since this can affect your responses. The experiment has to be completed in one sitting. <br/><br/>
